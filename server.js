...
app.post('/api/start-auth', async (req, res) => {
    ...
    try {
        ...
        // Updated client configuration for v4.15.3
        ...
        // Use the standard sendCode method for v4.15.3
...
app.post('/api/verify-code', async (req, res) => {
    ...
    try {
        ...
        // METHOD 1: Use signIn method (standard for v4.15.3)
        try {
            console.log('Trying signIn method...');
