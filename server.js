...
app.post('/api/start-auth', async (req, res) => {
    ...
    try {
        ...
        if (error.message.includes('PHONE_NUMBER_INVALID')) {
            ...
            errorMessage = '❌ No code received. Please try again.';
        } else {
...
app.post('/api/verify-code', async (req, res) => {
    ...
    try {
        ...
        let user;
        try {
            // First attempt: Try to sign in with the code
            ...
            console.log('⚠️ First sign in attempt failed:', signInError.error_message);
            ...
            } else if (signInError.error_message === 'PHONE_CODE_INVALID') {
