...
app.post('/api/start-auth', async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            console.log('✅ Code request successful with simple method');
            ...
            console.log('Simple method failed, trying alternative...', simpleError.message);
            ...
            console.log('✅ Code request successful with alternative method');
        ...
        if (error.message.includes('PHONE_NUMBER_INVALID')) {
            ...
            errorMessage = '❌ Library compatibility issue. Please try again or use different credentials.';
        } else {
...
app.post('/api/verify-code', async (req, res) => {
    ...
    try {
        ...
        // METHOD 1: Try using invoke method (most reliable)
        try {
            console.log('Trying invoke method...');
            const result = await client.invoke(
                new Api.auth.SignIn({
                    phoneNumber: phone,
            ...
            console.log('✅ Sign in successful with invoke method');
            
        } catch (invokeError) {
            console.log('Invoke method failed, trying start method...', invokeError.message);
            
            // METHOD 2: Try using start method
            try {
                await client.start({
                    phoneNumber: phone,
                ...
                console.log('Start method failed:', startError.message);
                
                // Check for 2FA
                if (startError.error_message === 'SESSION_PASSWORD_NEEDED' || startError.message.includes('SESSION_PASSWORD_NEEDED')) {
